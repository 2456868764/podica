...
def override_config(base_config, override_config):
    """Override base config with override config values."""
...
def get_lowercase_keys_config(config):
    ...
    if isinstance(config, dict):
        ...
        return [get_lowercase_keys_config(item) for item in config]
    else:
        return config
