...
class TextNormalizer:
    ...
    def load(self):
        ...
        # Try to use tn (WeTextProcessing) on Linux, fallback to wetext if not available
        if platform.system() == "Linux":
            try:
                ...
                # Fallback to wetext if tn is not available
                pass
        
        # Use wetext for Mac, Windows, or as fallback on Linux
